...
def smooth_probabilities(probabilities):
    whittaker_smoother = WhittakerSmoother(
        lmbda=1000, order=2, data_length=len(probabilities)
    )
...
def smooth_fragment_centers(fragment_center_array):
    whittaker_smoother = WhittakerSmoother(
    lmbda=10000, order=2, data_length=len(fragment_center_array))
    smoothed_fragment_centers = np.array(whittaker_smoother.smooth(fragment_center_array))
    sigma = 20  # Adjust sigma to control the width of the smoothing
...
def get_data_phase_shift(length, num_regular_peaks, num_phase_shifted_peaks, min_fragment_length, max_fragment_length, number_of_fragments):
    ...
    fragment_array = create_fragment_array(positions, length, min_fragment_length, max_fragment_length)
    wps_array = calculate_wps_optimized(fragment_array, length)
    # wps_array = create_fragment_center_array(positions, length)
    # wps_array = smooth_fragment_centers(wps_array)
#     nucleosome_positions +=100
    wps_array = wps_array[:length]

    link = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/smoothed_array_phase_shift" + ".tsv.gz"
    link2 = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/nucleosome_positions_phase_shift" + ".tsv"
...
#     nucleosome_positions +=100
    ...
    link = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/smoothed_array_only_regular" + ".tsv.gz"
    link2 = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/nucleosome_positions_only_regular"  + ".tsv"
    np.savetxt(link2, nucleosome_positions, delimiter='\t', fmt='%d')
    save_data_as_tsv_gz(wps_array,link )
...
#     nucleosome_positions +=100
    ...
    link = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/smoothed_array_only_random"  + ".tsv.gz"
    link2 = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/nucleosome_positions_only_random"  + ".tsv"
    np.savetxt(link2, nucleosome_positions, delimiter='\t', fmt='%d')
    save_data_as_tsv_gz(wps_array,link )
...
#     nucleosome_positions +=100
    ...
    link = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/smoothed_array_with_random"  + ".tsv.gz"
    link2 = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/nucleosome_positions_with_random"  + ".tsv"
    np.savetxt(link2, nucleosome_positions, delimiter='\t', fmt='%d')
    save_data_as_tsv_gz(wps_array,link )
...
#     nucleosome_positions +=100
    ...
    link = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/smoothed_array_with_remove"  + ".tsv.gz"
    link2 = "/mnt/DATA1/nucleosome/wps/BH01/Monte_carlo/test_all/test_many_times_new/nucleosome_positions_with_remove"  + ".tsv"
    np.savetxt(link2, nucleosome_positions, delimiter='\t', fmt='%d')
    save_data_as_tsv_gz(wps_array,link )
...
length = 20_000
coverage = 75
number_of_nucleosomes = 100
number_of_fragments = int(coverage * length / fragment_length)
...
test = get_data_phase_shift(length, 66, 34, min_fragment_length, max_fragment_length,number_of_fragments)
